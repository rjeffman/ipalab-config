...
Open URL in the default browser, with the given profile (defaults to 'ipalab-profile').

Firefox is supported as package or Flatpak, and Google Chrome is supported if installed as a package. If you have issues with a flatpak browser, try using '-w'.
